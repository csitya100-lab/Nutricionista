    ...
    <div className="flex h-screen bg-rose-50 overflow-hidden">
      ...
      `}>
        ...
        <div className="p-4 mt-auto">
          <button className="w-full flex items-center gap-3 px-4 py-3 text-rose-100 hover:bg-white/10 rounded-xl transition-colors">
            <Settings size={20} />
            <span>Configurações</span>
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-3 text-rose-200 hover:text-white mt-1 transition-colors">
            <LogOut size={20} />
            <span>Sair</span>
          </button>
        </div>
